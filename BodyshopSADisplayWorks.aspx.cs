...
public partial class BodyshopSADisplayWorks : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Session["ROLE"] == null || Session["ROLE"].ToString() != "WORK MANAGER" && Session["ROLE"].ToString() != "FRONT OFFICE" && Session["ROLE"].ToString() != "SERVICE ADVISOR" && Session["ROLE"].ToString() != "CRM" && Session["ROLE"].ToString() != "DISPLAY")
            {
                Response.Redirect("login.aspx");
            }
        }
            ...
            try
            {
                ...
                if (!(Request.Form["_EventTarget"] != null && Request.Form["_EventTarget"] == "myClick"))
                {
                    ...
                    if (grdDisplay.SelectedRow.Cells[1].Text.Replace("&nbsp;", "").Trim().Replace("<div style=width:26px;>", "").Replace("</div>", "") != "")
                    {
                        ...
                        lblvcvehicleno.Text = regno;
                        lblvovehicleno.Text = regno;
                        lblRefnoParts.Text = grdDisplay.SelectedRow.Cells[24].Text.Replace("&nbsp;", "").Trim();
                        lblrefno.Text = grdDisplay.SelectedRow.Cells[24].Text.Replace("&nbsp;", "").Trim();
                        getPDTPDC(grdDisplay.SelectedRow.Cells[24].Text.Replace("&nbsp;", "").Trim());
                        BindPartsGrid(Convert.ToInt16(lblRefnoParts.Text));
                        getRemainingTabs(grdDisplay.SelectedRow.Cells[24].Text.Replace("&nbsp;", "").Trim(), grdDisplay.SelectedRow.RowIndex.ToString());
                        if (Session["ROLE"].ToString() == "CRM")
                        {
                            TabContainer1.Visible = false;
                        }
    ...
    protected void grdDisplay_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (grdDisplay.DataSource != null || GridView1.DataSource != null)
        {
            ...
            string counter = "";
            string StatusTech = "";
            string RefNo = e.Row.Cells[24].Text.ToString();
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[8].Text = "<div style='width:100px;height:42px'><table style='width:100%;Height:100%;' border='0' cellpadding='0' cellspacing='0'><tr><td style='height:50%;' colspan='2'>PARTS STATUS</td></tr><tr><td align='center'>REQ.</td><td align='center'>AVL.</td></tr></table></div>";
                ...
                e.Row.Cells[18].Text = "<div style=width:30px;>" + e.Row.Cells[18].Text.ToString() + "</div>";
                e.Row.Cells[19].Text = "<div style=width:30px;>" + e.Row.Cells[19].Text.ToString() + "</div>";
                e.Row.Cells[20].Text = "<div style=Height:25px;width:20px;></div>";
                e.Row.Cells[21].Text = "<div style=width:65px;>" + e.Row.Cells[21].Text.ToString() + "</div>";
                e.Row.Cells[22].Text = "<div style=>" + e.Row.Cells[22].Text.ToString() + "</div>";
                e.Row.Cells[23].Text = "<div style=width:30px;>" + e.Row.Cells[23].Text.ToString() + "</div>";
            }
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                try
                {
                    ...
                    {
                        e.Row.Cells[6].Text = "<div style=width:45px;text-align:center;><img src='images/JCR/Status.png' Alt=''  width='16' height='16'/></div>";
                        e.Row.Cells[6].ToolTip = "Work In Progress";
                    }
                    else if (status_str[0] == "1-0-0")
                    {
                        e.Row.Cells[6].Text = "<div style=width:45px;text-align:center;><img src='images/JCR/Status_Ready.png' Alt='' width='16' height='16'/></div>";
                        e.Row.Cells[6].ToolTip = "Vehicle Ready [" + status_str[1].Trim() + "]";
                    }
                    else if (status_str[0] == "0-1-0")
                    {
                        e.Row.Cells[6].Text = "<div style=width:45px;text-align:center;><img src='images/JCR/Status_HOLD.png' Alt='' width='16' height='16'/></div>";
                        e.Row.Cells[6].ToolTip = "Hold";
                    }
                    else if (status_str[0] == "0-0-1")
                    {
                        e.Row.Cells[6].Text = "<div style=width:45px;text-align:center;><img src='images/JCR/Status_IDLE.png' Alt='' width='16' height='16'/></div>";
                ...
                try
                {
                    ...
                    if (status == "0")
                    {
                        if (e.Row.Cells[7].Text.ToString().Contains('*'))
                            e.Row.Cells[7].Text = "<div style=width:30px;><img src='images/JCR/SA Allot.png' Alt=''  width='16' height='16'/></div>";
                        else
                            e.Row.Cells[7].Text = "<div style=width:30px;></div>";
                    }
                    else if (status == "1")
                        e.Row.Cells[7].Text = "<div style=width:30px;><img src='images/JCR/SA WIP ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    else if (status == "2")
                        e.Row.Cells[7].Text = "<div style=width:30px;><img src='images/JCR/SA WIP NEAR.png' Alt=''  width='16' height='16'/></div>";
                    else if (status == "3")
                        e.Row.Cells[7].Text = "<div style=width:30px;><img src='images/JCR/SA WIP DELAY.png' Alt=''  width='16' height='16'/></div>";
                    else if (status == "4")
                        e.Row.Cells[7].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                    else if (status == "5")
                        e.Row.Cells[7].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='16'/></div>";
                    else if (status == "6")
                        e.Row.Cells[7].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                }
                catch (Exception ex)
                {
                }
                //PARTS STATUS
                string parts = "<div style='width:100px;'><table style='width:100%;' border='0' cellpadding='0' cellspacing='0'><tr><td align='center' style='width:50px;'>";

                if (e.Row.Cells[8].Text.ToString().Trim() == "0")
                {
                    parts = parts + "<img src='images/Red.png' Alt='' width='16' height='16'/>";
                }
                else if (e.Row.Cells[8].Text.ToString().Trim() == "1")
                {
                    parts = parts + "<img src='images/Green.png' Alt='' width='16' height='16'/>";
                }
                parts = parts + "</td><td align='center' style='width:50px;'>";
                ...
                {
                    parts = parts + "<img src='images/Light.png' Alt='' width='16' height='16'/>";
                }
                ...
                {
                    parts = parts + "<img id='animg' src='images/Yellow With Near.png' Alt='' width='16' height='16'/>";
                }
                ...
                try
                {
                    ...
                    if (status == "0")
                        ...
                        e.Row.Cells[10].Text = "<div style=width:30px;><img src='images/JCR/JA ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    else if (status == "2")
                        e.Row.Cells[10].Text = "<div style=width:30px;><img src='images/JCR/JA DELAY.png' Alt=''  width='16' height='16'/></div>";
                }
                catch (Exception ex)
                {
                }
                ...
                try
                {
                    ...
                    if (status == "0")
                    {
                        ...
                        if (StatusTech == "0")
                            ...
                            e.Row.Cells[11].Text = "<div style=width:30px;><img src='images/JCR/TECH ALLOT.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "1")
                    {
                        e.Row.Cells[11].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "2")
                    {
                        if (blinkflag == 1)
                            e.Row.Cells[11].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP NEAR.png' Alt='' width='16' height='16'/></div>";
                        else
                            e.Row.Cells[11].Text = "<div style=width:40px;><img id='animg' src='images/JCR/TECH WIP NEAR.png' Alt='' width='16' height='16'/></div>";
                    }
                    else if (status == "3")
                    {
                        e.Row.Cells[11].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP DELAY.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "4")
                    {
                        e.Row.Cells[11].Text = "<div style=width:40px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "5")
                    {
                        e.Row.Cells[11].Text = "<div style=width:40px;><img src='images/JCR/CR.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "6")
                    {
                        e.Row.Cells[11].Text = "<div style=width:40px;><img src='images/JCR/OutSkipped.png' Alt='' width='16' height='16'/></div>";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    if (status == "0")
                    {
                        if (Convert.ToInt16(StatusTech) > 1)
                            e.Row.Cells[12].Text = "<div style=width:30px;><img src='images/JCR/TECH ALLOT.png' Alt=''  width='16' height='16'/></div>";
                        else
                            e.Row.Cells[12].Text = "<div style=width:30px;></div>";
                    }
                    else if (status == "1")
                    {
                        e.Row.Cells[12].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "2")
                    {
                        if (blinkflag == 1)
                            e.Row.Cells[12].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP NEAR.png' Alt='' width='16' height='16'/></div>";
                        else
                            e.Row.Cells[12].Text = "<div style=width:40px;><img id='animg' src='images/JCR/TECH WIP NEAR.png' Alt='' width='16' height='16'/></div>";
                    }
                    else if (status == "3")
                    {
                        e.Row.Cells[12].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP DELAY.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "4")
                    {
                        e.Row.Cells[12].Text = "<div style=width:40px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "5")
                    {
                        e.Row.Cells[12].Text = "<div style=width:40px;><img src='images/JCR/CR.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "6")
                    {
                        e.Row.Cells[12].Text = "<div style=width:40px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    if (status == "0")
                    {
                        if (Convert.ToInt16(StatusTech) > 2)
                            e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/TECH ALLOT.png' Alt=''  width='16' height='16'/></div>";
                        else
                            e.Row.Cells[13].Text = "<div style=width:30px;></div>";
                    }
                    else if (status == "1")
                    {
                        e.Row.Cells[13].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "2")
                    {
                        if (blinkflag == 1)
                            e.Row.Cells[13].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP NEAR.png' Alt='' width='16' height='16'/></div>";
                        else
                            e.Row.Cells[13].Text = "<div style=width:40px;><img id='animg' src='images/JCR/TECH WIP NEAR.png' Alt='' width='16' height='16'/></div>";
                    }
                    else if (status == "3")
                    {
                        e.Row.Cells[13].Text = "<div style=width:40px;><img src='images/JCR/TECH WIP DELAY.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "4")
                    {
                        e.Row.Cells[13].Text = "<div style=width:40px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "5")
                    {
                        e.Row.Cells[13].Text = "<div style=width:40px;><img src='images/JCR/CR.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "6")
                    {
                        e.Row.Cells[13].Text = "<div style=width:40px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    if (e.Row.Cells[14].Text.ToString().Contains('*'))
                    {
                        ...
                        if (status == "0")
                            if (e.Row.Cells[14].Text.ToString().Contains('$'))
                                e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/NotRequired.png' Alt=''  width='16' height='16'/></div>";
                            else
                                e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/WA allot.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "1")
                            e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/WA WIP.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "2")
                            e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/WA WIP NEAR.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "3")
                            e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/WA WIP Delay.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "4")
                            e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "5")
                            e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "6")
                ...
                try
                {
                    ...
                    {
                        e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/RT ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "4" || status == "5")
                    {
                        if (counter == "1")
                        {
                            e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (counter == "2")
                        {
                            e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CN2.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (counter == "3")
                        {
                            e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CN3.png' Alt=''  width='16' height='16'/></div>";
                        }
                    }
                    else if (status == "6")
                    {
                ...
                try
                {
                    string getWSH = (e.Row.Cells[16].Text.Trim() == "&nbsp;" ? "" : e.Row.Cells[16].Text.Trim());
                    string[] WSHParts = { };
                    if (getWSH.Contains("|"))
                    {
                        WSHParts = getWSH.Split('|');
                    }
                    e.Row.Cells[16].Attributes.Add("onmouseover", "showProcessInOut(event,'" + RefNo + "','" + WSHParts[2].Replace("#", "").Replace("$", "").Replace("*", "") + "','Wash')");
                    ...
                    if (e.Row.Cells[16].Text.ToString().Contains('*'))
                    {
                        ...
                        {
                            if (e.Row.Cells[16].Text.ToString().Contains('$'))
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/NotRequired.png' Alt=''  width='16' height='16'/></div>";
                            else
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/WASH allot.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "1")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/WASH WIP.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "2")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/WASH WIP NEAR.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "3")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/WASH WIP Delay.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "4")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='18'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CN2.png' Alt=''  width='16' height='18'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CN3.png' Alt=''  width='16' height='18'/></div>";
                            }
                        }
                        else if (status == "5")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='18'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CR2.png' Alt=''  width='16' height='18'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CR3.png' Alt=''  width='16' height='18'/></div>";
                            }
                        }
                        else if (status == "6")
                        {
                    ...
                    else
                    {
                        ...
                        if (status == "0")
                        {
                            if (e.Row.Cells[16].Text.ToString().Contains('$'))
                                ...
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/WASH.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "1")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/WASH WIP.png' Alt=''  width='16' height='16'/></div>";
                ...
                try
                {
                    int repeatStatus = e.Row.Cells[17].Text.Trim().Contains("R") == true ? 1 : 0;
                    e.Row.Cells[17].Text = e.Row.Cells[17].Text.Trim().Replace("R", "");

                    string getFIN = (e.Row.Cells[17].Text.Trim() == "&nbsp;" ? "" : e.Row.Cells[17].Text.Trim());
                    string[] FINParts = { };
                    if (getFIN.Contains("|"))
                    {
                        FINParts = getFIN.Split('|');
                    }
                    e.Row.Cells[17].Attributes.Add("onmouseover", "showProcessInOut(event,'" + RefNo + "','" + FINParts[2].Replace("#", "").Replace("$", "").Replace("*", "") + "','FI')");
                    ...
                    if (repeatStatus == 0)
                    {
                        ...
                        {
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/QC WIP.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "2")
                        {
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/QC WIP Near.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "3")
                        {
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/QC WIP Delay.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "4")
                        {
                            if (counter == "1")
                            ...
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CN2.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CN3.png' Alt='' width='16' height='16'/></div>";
                            }
                        }
                        else if (status == "5")
                        {
                            ...
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CR2.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CR3.png' Alt='' width='16' height='16'/></div>";
                            }
                        }
                        else if (status == "6")
                        {
                    ...
                    else
                    {
                        ...
                        {
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/QC WIPR.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "2")
                        {
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/QC WIP NearR.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "3")
                        {
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/QC WIP DelayR.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "4")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CNR.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CNR2.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CNR3.png' Alt='' width='16' height='16'/></div>";
                            }
                        }
                        else if (status == "5")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CRR.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CRR2.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CRR3.png' Alt='' width='16' height='16'/></div>";
                            }
                        }
                        else if (status == "6")
                        {
                ...
                try
                {
                    string getVAS = (e.Row.Cells[18].Text.Trim() == "&nbsp;" ? "" : e.Row.Cells[18].Text.Trim());
                    string[] VASParts = { };
                    if (getVAS.Contains("|"))
                    {
                        VASParts = getVAS.Split('|');
                    }
                    e.Row.Cells[18].Attributes.Add("onmouseover", "showProcessInOut(event,'" + RefNo + "','" + VASParts[2].Replace("#", "").Replace("$", "").Replace("*", "") + "','VAS')");
                    ...
                    if (e.Row.Cells[18].Text.ToString().Contains('*'))
                    {
                        ...
                        if (status == "0")
                            if (e.Row.Cells[18].Text.ToString().Contains('$'))
                                e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/NotRequired.png' Alt=''  width='16' height='16'/></div>";
                            else
                                e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/PK4.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "1")
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/PK.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "2")
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/PK1.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "3")
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/PK3.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "4")
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='18'/></div>";
                        else if (status == "5")
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='18'/></div>";
                        else if (status == "6")
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else
                    {
                        status = e.Row.Cells[18].Text.ToString().Substring(0, 1);
                        if (status == "0")
                            ...
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "5")
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "6")
                            e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                }
                ...
                try
                {
                    string[] jcc_str = e.Row.Cells[19].Text.ToString().Trim().Split('|');
                    if (jcc_str[0] == "0-0")
                    {
                        e.Row.Cells[19].Text = "<div style=width:30px;></div>";
                        e.Row.Cells[19].ToolTip = "Not Closed";
                    }
                    else if (jcc_str[0] == "1-0")
                    {
                        e.Row.Cells[19].Text = "<div style=width:30px;><img src='images/JCR/JCC SKIP.png' Alt=''  width='16' height='16'/></div>";
                        e.Row.Cells[19].ToolTip = "Closed but not informed [" + jcc_str[1].Trim() + "]";
                    }
                    else if (jcc_str[0] == "1-1")
                    {
                        e.Row.Cells[19].Text = "<div style=width:30px;><img src='images/JCR/JCC ONTIME.png' Alt=''  width='16' height='16'/></div>";
                        e.Row.Cells[19].ToolTip = "Closed and informed [" + jcc_str[1].Trim() + "]";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    string getIFB = (e.Row.Cells[20].Text.Trim() == "&nbsp;" ? "" : e.Row.Cells[20].Text.Trim());
                    if (getIFB == "1")
                        e.Row.Cells[20].ToolTip = "On Time";
                    else if (getIFB == "0")
                        e.Row.Cells[20].ToolTip = "No PDT";
                    else if (getIFB == "2")
                        e.Row.Cells[20].ToolTip = "Approaching";
                    else
                        e.Row.Cells[20].ToolTip = "Delayed";

                    if (e.Row.Cells[20].Text.ToString() == "0")
                        e.Row.Cells[20].Text = "<div style=width:20px;></div>";
                    else if (e.Row.Cells[20].Text.ToString() == "1")
                        e.Row.Cells[20].Text = "<div style=width:20px;><img src='images/JCR/circle_green.png' Alt=''  width='14' height='14'/></div>";
                    else if (e.Row.Cells[20].Text.ToString() == "2")
                        e.Row.Cells[20].Text = "<div style=width:20px;><img src='images/JCR/circle_yellow.png' Alt=''  width='14' height='14'/></div>";
                    else if (e.Row.Cells[20].Text.ToString() == "3")
                        e.Row.Cells[20].Text = "<div style=width:20px;><img src='images/JCR/circle_red.png' Alt=''  width='14' height='14'/></div>";
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    if (e.Row.Cells[21].Text.ToString().Contains('#'))
                    {
                        if (e.Row.Cells[21].Text.ToString().Contains('Y'))
                        {
                            e.Row.Cells[21].Text = "<div style=width:65px;color:BLUE;>" + e.Row.Cells[21].Text.Replace('#', ' ').Replace('Y', ' ').ToString().Trim() + "</div>";
                        }
                        else
                        {
                            e.Row.Cells[21].Text = "<div style=width:65px;color:RED;>" + e.Row.Cells[21].Text.Replace('#', ' ').Replace('N', ' ').ToString().Trim() + "</div>";
                        }
                    }
                    else
                    {
                        e.Row.Cells[21].Text = "<div style=width:65px;color:GRAY;>" + e.Row.Cells[21].Text.Replace('$', ' ').ToString().Trim() + "</div>";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    e.Row.Cells[22].Text = "<div style=width:20px;>" + e.Row.Cells[22].Text.ToString() + "</div>";
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    if (e.Row.Cells[23].Text.Trim() == "1")
                    {
                        e.Row.Cells[23].Attributes.Add("onmouseover", "showRemarks(event,'" + RefNo + "')");
                        e.Row.Cells[23].Attributes.Add("onmouseout", "hideTooltip(event)");
                    }

                    if (e.Row.Cells[23].Text.ToString() == "0")
                        e.Row.Cells[23].Text = "<div style=width:30px;></div>";
                    else
                        e.Row.Cells[23].Text = "<div style=width:30px;><img src='images/JCR/REMARKS ENTRY.png' Alt=''  width='16' height='16'/></div>";
                }
                catch (Exception ex)
                { }
            }
    ...
    //            e.Row.Cells[10].Text = "<div style=width:30px;>" + e.Row.Cells[10].Text.ToString() + "</div>";
    //            e.Row.Cells[11].Text = "<div style=width:30px;>" + e.Row.Cells[11].Text.ToString() + "</div>";
    //            e.Row.Cells[12].Text = "<div style=width:40px;>" + e.Row.Cells[12].Text.ToString() + "</div>";
    //            e.Row.Cells[13].Text = "<div style=width:30px;>" + e.Row.Cells[13].Text.ToString() + "</div>";
    //            e.Row.Cells[14].Text = "<div style=width:30px;>" + e.Row.Cells[14].Text.ToString() + "</div>";
    //            e.Row.Cells[15].Text = "<div style=width:30px;>" + e.Row.Cells[15].Text.ToString() + "</div>";
    //            e.Row.Cells[16].Text = "<div style=width:30px;>" + e.Row.Cells[16].Text.ToString() + "</div>";
    ...
    //            e.Row.Cells[20].Text = "<div style=width:65px;>" + e.Row.Cells[20].Text.ToString() + "</div>";
    //            e.Row.Cells[21].Text = "<div style=width:30px;>" + e.Row.Cells[21].Text.ToString() + "</div>";
    //            e.Row.Cells[22].Text = "<div style=width:30px;>" + e.Row.Cells[22].Text.ToString() + "</div>";
    //        }
    ...
    //                    e.Row.Cells[3].Text = "<div style=width:50px;></div>";
    //                else if (e.Row.Cells[3].Text.ToString() == "1-0")
    //                    e.Row.Cells[3].Text = "<div style=width:50px;><img src='images/JCR/JDP.png' Alt=''  width='24' height='16'/></div>";
    //                else if (e.Row.Cells[3].Text.ToString() == "0-1")
    //                    e.Row.Cells[3].Text = "<div style=width:50px;><img src='images/JCR/Customer Waiting.png' Alt=''  width='24' height='16'/></div>";
    //                else if (e.Row.Cells[3].Text.ToString() == "1-1")
    ...
    protected void btnCloseJCC_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            lblmsg.Text = "Repair Order Closed Successfully.!";
        }
    }
