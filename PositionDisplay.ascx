<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PositionDisplay.ascx.cs" Inherits="PositionDisplay" %>
<style type="text/css">
    .style1
    {
        height: 16px;
...
<div style="width: 99%; height: 60px; text-align: center; vertical-align: middle;">
