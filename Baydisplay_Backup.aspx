<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Baydisplay_Backup.aspx.cs" Inherits="Baydisplay1" %>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="timeLinePnl" runat="server" Height="100%" Width="100%">
                            <asp:GridView ID="timeLine" runat="server" CellPadding="4" ForeColor="#333333" OnRowDataBound="timeLine_RowDataBound"
                                AllowPaging="True" PageSize="16" Width="100%" 
                                HeaderStyle-BackColor="#00376F">
                                <RowStyle BackColor="WhiteSmoke" Font-Names="Consolas, Georgia"  
