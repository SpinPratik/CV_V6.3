<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="ProcessDevice_New.aspx.cs" Inherits="ProcessDevice_New" %>
                        ...
                        <Columns>
                           ...
                           <%-- <asp:TemplateField HeaderText="Bodyshop" ItemStyle-HorizontalAlign="left" FooterStyle-HorizontalAlign="left">
                            ...
                            <asp:TemplateField HeaderText="Bodyshop">
                                <EditItemTemplate>
                                <asp:CheckBox ID="chk_isbodyshop" OnCheckedChanged="chk_isbodyshop_CheckedChanged" Checked='<%# Eval("IsBodyshop").ToString()=="True"?true:false %>' runat="server" AutoPostBack="true"/>
                               
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:CheckBox ID="chk_isbodyshop" OnCheckedChanged="chk_isbodyshop_CheckedChanged"  runat="server" AutoPostBack="true"/>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Location Name">
                                <EditItemTemplate>
                                                ...
                                                <asp:DropDownList ID="drplocnameEdit" runat="server" ValidationGroup="ab1" AutoPostBack="True" CssClass="form-control"
                                                    AppendDataBoundItems="true" SelectedValue='<%# Bind("LocationName") %>'  Visible='<%# Eval("IsBodyshop").ToString()=="0"?true:false %>' OnSelectedIndexChanged="drplocnameEdit_SelectedIndexChanged" >
                                      ...
                                      <asp:DropDownList ID="DropDownList1" runat="server" ValidationGroup="ab1" AutoPostBack="True" CssClass="form-control"
                                                    AppendDataBoundItems="true" SelectedValue='<%# Bind("LocationName") %>' Visible='<%# Eval("IsBodyshop").ToString()=="1"?true:false %>' OnSelectedIndexChanged="drplocnameEdit_SelectedIndexChanged" >
                                ...
                                <FooterTemplate>
                                     ...
                                     <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drplocname_SelectedIndexChanged"
                            ...
                            <asp:TemplateField HeaderText="Process Owner">
                             ...
                             <asp:TemplateField HeaderText="Device SN">
                                ...
                                <FooterTemplate>
                                                ...
                                                <asp:TextBox ID="txtDeviceSN" runat="Server" CssClass="form-control" MaxLength="20" Width="100%"></asp:TextBox>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:Button ID="LinkButton31" CssClass="btn btn-danger" runat="server" CausesValidation="False" CommandName="Delete"
                                        Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this Bay?');"></asp:Button></ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
