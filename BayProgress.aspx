<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BayProgress.aspx.cs" Inherits="BayProgress" %>
...
<%--    <link rel="stylesheet" href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484214730/themes/scheduler_8.css" />--%>
    <link href="Themes/scheduler_8.css" rel="stylesheet" />
    <link rel="stylesheet" href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484285348/css/StyleCV.css" />
...
.complete30 .scheduler_8_event_bar_inner  
{
	/*background-color: green;*/
}
.complete70 .scheduler_8_event_bar_inner  
{
	/*background-color: orange;*/
}
.complete100 .scheduler_8_event_bar_inner  
{
	/*background-color: red;*/
}
    </style>
...
<body>
  <script type="text/javascript">
      var SchedulerColor = document.getElementsByClassName("scheduler_8_event_bar_inner");
      SchedulerColor[0].style.color = "green";
        ...
        <div class="container-fluid" style="position: relative;">
            <div class="row">
                 <div id="right-hidden-div" onmouseover="openNav1()" onmouseout="closeNav1()" class="right-hidden">
                     ...
                     <center><h4 style="color: #ee8000;font-weight: bold;">VEHICLES</h4></center><hr />
