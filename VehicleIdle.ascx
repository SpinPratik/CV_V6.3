<%@ Control Language="C#" AutoEventWireup="true" CodeFile="VehicleIdle.ascx.cs" Inherits="VehicleIdle" %>
<style type="text/css">
    .style1
    {
        height: 16px;
...
<div style="width: 99%; height: 56px; text-align: center; vertical-align: middle;">
    <div id="VehicleBG" runat="server" style="width: 99%; height: 52px; border: 1px solid #666666;
        white-space: nowrap;">
        <table style="width: 100%; height: 100%;" border="0" cellpadding="0" 
            ...
            <tr>
                ...
                <td align="left" 
                    style="white-space: nowrap; font-weight: bold; padding-left: 5px;" 
                    class="style2">
            ...
            <tr>
                <td align="left" 
                    style="white-space: nowrap; font-size: 12px; padding-left: 5px;" 
                    class="style3">
                ...
                <td style="font-size: 12px; color: White;
                    ...
                    <asp:Label ID="lbl_GateInTime" runat="server"></asp:Label>
                </td>
            ...
            <tr>
                <td align="left" 
                    style="white-space: nowrap; font-size: 12px; padding-left: 5px;" class="style2">
                    <asp:Label ID="lbl_ServiceAdvisor" runat="server" Text=" "></asp:Label>
                </td>
                <td style="font-family: arial, Helvetica, sans-serif; font-size: 10px; color: #0066FF;
