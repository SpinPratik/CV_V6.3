<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule_New.master" AutoEventWireup="true"
    CodeFile="SMHome.aspx.cs" Inherits="SMHome" %>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="second background-white">
                                 <div style="margin: 20px;">
                                     <asp:HyperLink ID="HyperLink6" NavigateUrl="DisplaySM.aspx" runat="server" Text="display">
          <center> 
              ...
              <div>      
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="third background-white">
                            <div style="margin: 20px;">  
                                <asp:HyperLink ID="HyperLink5" NavigateUrl="SMReports.aspx" runat="server" Text="reports">
                                <center>
                                    <div>      
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="forth background-white">
                            <div style="margin: 20px;"> 
                                <asp:HyperLink ID="HyperLink4" Target="_blank" NavigateUrl="http://smartdashboard.vtabs.in/" runat="server">
                                   <center>
                                        <div>      
                                       <img src="images/DisplayCard/smartdashboard.png" alt="SmartDashboard" height="128px" width="128px"/>
                                        </div>
