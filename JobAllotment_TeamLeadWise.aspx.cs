...
public partial class JobAllotment_TeamLeadWise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (Session["ROLE"] == null || Session["ROLE"].ToString() != "WORK MANAGER" && Session["ROLE"].ToString() != "TEAM LEAD")
            {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                getAllBays();
                getShift();
                GetTechnicianName(cmbTechName, "Mechanic",Session["EmpId"].ToString(), ddlShift.SelectedValue.ToString(), false, tbAllotDate.Text);
    ...
    private void RefreshGrid()
    {
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@TeamLeadId", Session["EmpId"].ToString());
            else
    ...
    protected void getAllBays()
    {
        ...
        sda1.SelectCommand.Parameters.AddWithValue("@TLId", Session["EmpId"].ToString());
    ...
    {
        SqlCommand cmd1 = new SqlCommand("SELECT ShiftID, Shift FROM tblShift ORDER BY Shift", con);
    ...
    //{
    //    ClearAll();
    //    GetTechnicianName(cmbTechName, ddlEmpType.SelectedItem.Text.Trim(), Session["EmpId"].ToString(), ddlShift.SelectedValue.ToString(), false, tbAllotDate.Text);
    //    timeLine.Visible = false;
    //    timeLine_Bay.Visible = false;
    //}
    ...
    protected void btn_Back_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else if (Session["ROLE"].ToString() == "TEAM LEAD")
        {
            Response.Redirect("TeamLeadHome.aspx");
        }
    }
