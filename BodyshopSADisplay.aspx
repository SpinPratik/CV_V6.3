<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BodyshopSADisplay.aspx.cs" Inherits="BodyshopSADisplay" %>
...
<%--    <link href="Icons/ProTRAC Icon.ico" rel="shortcut icon" type="image/x-icon" />--%>
    ...
    <script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286920/js/jquery-ui-1.8.1.custom.min.js" type="text/javascript"></script>
      <script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286920/js/jquery-1.3.2.js" type="text/javascript"></script>
    <script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286919/js/customgitter.js" type="text/javascript"></script>
<script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286919/js/customgitter.js" type="text/javascript"></script>
    <link href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484287496/css/cupertino/jquery-ui-1.8.1.custom.css" rel="stylesheet" type="text/css" />
 <script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286893/js/jquery-1.4.2.min.js" type="text/javascript"></script>
      <link href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484631755/css/jquery.gritter.css" rel="stylesheet" type="text/css" />
    <link href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484631756/css/jquery.gritter2.css" rel="stylesheet" type="text/css" />
    <script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286919/js/customgitter.js" type="text/javascript"></script>
    <script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286919/js/Tooltip.js" type="text/javascript"></script>
   <link href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286797/css/ProTRAC_CssJCR.css" rel="stylesheet" />
    <link href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484631756/css/notify-osd.css" rel="stylesheet" type="text/css" />
    <link href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484285348/css/Style.css" rel="stylesheet" />
    <%--<script src="js/jquery-1.4.4.min.js" type="text/javascript"></script>--%>
    <script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286918/js/notify-osd.js" type="text/javascript"></script>


    <link rel="stylesheet" type="text/css" href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484631756/css/normalize.css" />
    <link rel="stylesheet" type="text/css" href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484631755/css/demo.css" />
    ...
    function () {
        ...
        function showDetails(e, ServiceId, ProcessName) {
            $.ajax({
                type: "POST",
                url: "BodyshopSADisplay.aspx/LoadInOutTime",
        ...
        function showRegNoHover(e, RefNo) {
            ...
            $.ajax({
                type: "POST",
                url: "BodyshopSADisplay.aspx/LoadRegNoHover",
                data: "{'RefNo':'" + RefNo + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
        ...
        function showProcessInOut(e, RefNo, ProcessId, ProcessName) {
            $.ajax({
                type: "POST",
                url: "BodyshopSADisplay.aspx/LoadProcessInOutTime",
        ...
        function showSubProcessInOut(e, RefNo, SubProcessId, SubProcessName) {
            $.ajax({
                type: "POST",
                url: "BodyshopSADisplay.aspx/LoadSubProcessInOutTime",
        ...
        function showEmpInOut(e, Slno, EmpId, Tech) {
            $.ajax({
                type: "POST",
                url: "BodyshopSADisplay.aspx/LoadEmployeeInOutTime",
        ...
        function showJADHover(e, RefNo) {
            $.ajax({
                type: "POST",
                url: "BodyshopSADisplay.aspx/LoadJADetails",
                data: "{'RefNo':'" + RefNo + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
        ...
        function showPartsHover(e, RefNo) {
            $.ajax({
                type: "POST",
                url: "BodyshopSADisplay.aspx/LoadPartsDetails",
                data: "{'RefNo':'" + RefNo + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
        ...
        function showRemarks(e, RefNo) {
            $.ajax({
                type: "POST",
                url: "BodyshopSADisplay.aspx/LoadRemarks",
                data: "{'RefNo':'" + RefNo + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
    ...
    <form id="form1" runat="server">
        ...
        <div class="" style="height:100%;min-width:1100px;">
            ...
            <ul id="gn-menu" class="gn-menu-main" style="background-color: #1591cd !important;">
                 <li>
                    <a href="BodyshopSA.aspx">  <asp:ImageButton ImageUrl="images/left-arrow%20(1).png" ID="back" OnClick="back_Click1" runat="server" style="margin-top:15px;"></asp:ImageButton></a>
                </li>
        ...
        <table style="width: 100%; height: 100%; font-size: 13px;"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <div id="mainTab">
                                    <cc1:TabContainer ID="TabContainer1" CssClass="MyTabStyle" runat="server" ActiveTabIndex="2" 
                                        Width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:DropDownList ID="ddPDTRemarks" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                                                    OnSelectedIndexChanged="ddPDTRemarks_SelectedIndexChanged" CssClass="form-control" Visible="false">
                                                                </asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <asp:TextBox ID="txtRemarksReady" runat="server" CssClass="form-control" TextMode="MultiLine" MaxLength="250"></asp:TextBox>&#160;&#160;
                                                            </td>
                                                            <td valign="top">&#160;&#160;
                                                            </td>
                                                            <td valign="top">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <asp:Button CssClass="btn btn-success" ID="ImageButton4" runat="server" Text="Vehicle Out"
                                                                    OnClick="btnOut_Click" TabIndex="9" ToolTip="Vehicle Out" Width="131PX" ValidationGroup="a" />
                        ...
                        <table class="tblStyle" cellspacing="0">
                            <tr>
                               <%-- <td valign="top" style="white-space: nowrap; vertical-align: top; color: #333333; font-weight: bold; font-size: 12px; text-align: left;"></td>
                                ...
                                <td>
                                    ...
                                    <asp:SqlDataSource ID="srcServiceType" runat="server"
                                        SelectCommand="SELECT [ServiceType] FROM [tblServiceTypes_Bodyshop]"></asp:SqlDataSource>
                                </td>
                                <td>&nbsp;</td>
                                <td>
                                ...
                                <td>
                                    <asp:DropDownList ID="cmbProcess" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                        ...
                                        <asp:ListItem>Dismantling</asp:ListItem>
                                        <asp:ListItem>Denting</asp:ListItem>
                                        <asp:ListItem>Painting</asp:ListItem>
                                        <asp:ListItem>Refitting </asp:ListItem>
                                        <asp:ListItem>Final Inspection</asp:ListItem>
                                        <asp:ListItem>Reinspection</asp:ListItem>
                                    </asp:DropDownList>
                                       </td>
                                <td>&nbsp;</td>
                                <td>
                               ...
                               <%-- <td>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always">
                                            <ContentTemplate>
                                                <table>
                                                    <tr>
                                                        <td class="style4">
                                                            <asp:TextBox CssClass="form-control" ID="TxtDate1" runat="server" TabIndex="5" ValidationGroup="sg" placeholder="From" BackColor="White"></asp:TextBox>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td class="style4">
                                                            <asp:TextBox CssClass="form-control" ID="TxtDate2" runat="server" TabIndex="6" placeholder="To" BackColor="White"></asp:TextBox>
                                                        ...
                                                        <td class="style4">
                                                            <asp:ImageButton ID="btnSearch" runat="server" AlternateText="SEARCH" Height="20px"
                                                                ImageUrl="https://res.cloudinary.com/deekyp5bi/image/upload/v1484543292/img/search_2.png" OnClick="btnSearch_Click" ToolTip="Search" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ContentTemplate>
                                ...
                                <td style="background-image: url('https://res.cloudinary.com/deekyp5bi/image/upload/v1484543298/img/box.png'); background-repeat: no-repeat; background-position: center center; text-align: center; vertical-align: central; padding-left: 5px;"
                                    width="30">
            ...
            <tr style="width: 100%; left: 0;">
                <td align="center" style="width: 100%; left: 0;">
                    <asp:UpdatePanel ID="PnlDisplay" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <table class="GridPanel" border="0" cellpadding="0">
                                    ...
                                    <td style="width: 100%">
                                        <asp:Panel ID="Panel3" runat="server" CssClass="GridPanelJCRHeader">
                                            <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="0" ForeColor="#507CD1"
                                                ...
                                                OnSelectedIndexChanged="grdDisplay_SelectedIndexChanged" ShowHeader="True" CssClass="mydatagrid"
                                                ...
                                                <HeaderStyle  Font-Bold="True" ForeColor="WHITE" HorizontalAlign="left" BackColor="#1591cd" />
                                ...
                                <tr>
                                    <td style="width: 100%">
                                        <asp:Panel ID="Panel51" runat="server" CssClass="GridPanel" >
                                            <asp:GridView ID="grdDisplay" runat="server" Width="100%" CellPadding="0" ForeColor="#333333" CssClass="mydatagrid"
                                                OnRowDataBound="grdDisplay_RowDataBound" OnPageIndexChanging="grdDisplay_PageIndexChanging"
                                                OnSelectedIndexChanged="grdDisplay_SelectedIndexChanged" ShowHeader="true" GridLines="None">
                                                <EmptyDataTemplate>
                                                    <center>
                                                        <div class="NoData">
                                                            No Vehicle Received
