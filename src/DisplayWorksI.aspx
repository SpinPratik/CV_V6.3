<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayWorksI.aspx.cs" Inherits="DisplayWorksI"
...
<head id="Head1" runat="server">
   <%-- <link href="Icons/ProTRAC Icon.ico" rel="shortcut icon" type="image/x-icon" />--%>
    ...
    <script src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484286920/js/jquery.gritter.min.js" type="text/javascript"></script>
...
scrollbar[orient="vertical"] {
  min-width: 15px !important;
    ...
    <script type="text/javascript">
        ...
        function goAbout() {
            window.open('https://www.spintech.in', '_blank');
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Timer ID="Timer3" runat="server" OnTick="Timer3_Tick" Interval="100000">
        </asp:Timer>
        <%--    NOTIFICATION PANEL  --%>
        ...
        <div class="" style="height:100%;min-width:1100px;">
            ...
            <ul id="gn-menu" class="gn-menu-main" style="background-color: #ee8000 !important;">
                 <li>
                            ...
                            <td>
                                ...
                                <div id="mainTab">
                                    <cc1:TabContainer ID="TabContainer1" CssClass="MyTabStyle" runat="server" ActiveTabIndex="0" Height="100px"
                                                ...
                                                <table style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            ...
                                                            <asp:TextBox CssClass="form-control" ID="txtParts" runat="server" MaxLength="200"></asp:TextBox>
                                                            <cc1:AutoCompleteExtender
                                                                ID="txtParts_AutoCompleteExtender" runat="server" CompletionInterval="1" FirstRowSelected="True"
                                                                DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionList" ViewStateMode="Enabled"
                                                        ...
                                                        <td valign="top">
                                                            <asp:GridView ID="grdParts" CssClass="mydatagrid" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="LinkButton1" runat="server"  OnClientClick="return confirm('Are you sure you want to delete this Parts?');" CausesValidation="False" CommandName="Delete"
                                        ...
                                        <cc1:TabPanel ID="TabPanel6" runat="server" Visible="false" HeaderText="Vehicle Ready">
                                            <HeaderTemplate>
                                                Vehicle Ready
                                            </HeaderTemplate>
                                            <ContentTemplate>
                                        ...
                                        <cc1:TabPanel ID="TabPanel13" runat="server" HeaderText="JOBCARD Closing">
                                            <HeaderTemplate>
                                                JOBCARD Closing
                                            </HeaderTemplate>
                                            <ContentTemplate>
                                                <table class="tblStyle">
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;&nbsp;</td>
                                                        <td>
                                                            <asp:Label runat="server">JCC Informed</asp:Label>
                                        ...
                                        <cc1:TabPanel ID="TabPanel2" runat="server" Visible="false" HeaderText="Vehicle Out">
                                            <HeaderTemplate>
                                                Vehicle Out
                                            </HeaderTemplate>
                                            <ContentTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                              <td valign="top">
                                                                   <asp:Label runat="server" Text="&nbsp;"></asp:Label>
                                                                <asp:TextBox ID="txt_VORemarks" Placeholder="Add Remarks" CssClass="form-control" runat="server" MaxLength="100" TabIndex="32"
                                                                   ></asp:TextBox>
                                                            </td><td>&nbsp;</td>
                                                            <td valign="top">
                                                                <br />
                                                                <asp:Button CssClass="btn btn-success" ID="ImageButton4" Width="132px" runat="server" Text="Vehicle Out"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="style4">
                                                            <asp:ImageButton ID="btnSearch" runat="server" AlternateText="SEARCH" Height="20px"
                                                                ImageUrl="https://res.cloudinary.com/deekyp5bi/image/upload/v1484285976/search_2_ll3ccm.png" OnClick="btnSearch_Click" ToolTip="Search" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ContentTemplate>
                                ...
                                <tr>
                                    <td style="width: 100%">
                                        <asp:Panel ID="Panel3" runat="server" CssClass="GridPanelJCRHeader">
                                            <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="0" ForeColor="#507CD1"
                                                OnRowDataBound="grdDisplay_RowDataBound" CssClass="mydatagrid" 
                                                OnSelectedIndexChanged="grdDisplay_SelectedIndexChanged" ShowHeader="True" Height="45px"
                                                GridLines="None">
                                                <EmptyDataTemplate>
                                                    <center>
