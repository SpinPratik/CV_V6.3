<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="FIDisplay.aspx.cs"
    Inherits="FIDisplay" %>
...
<head id="Head1" runat="server">
    ...
    <link href="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484214710/css/Stylesheet.css" rel="stylesheet" type="text/css" />
...
<%--    <link href="CSS/ProTRAC_Css.css" rel="stylesheet" type="text/css" />--%>
  ...
  <script type="text/javascript" src="https://res.cloudinary.com/deekyp5bi/raw/upload/v1484285057/Bootstrap/bootstrap.min.js"></script>
    ...
    <title>Final Inspection Display</title>
</head>
    ...
    <table style="position: fixed; width: 100%; height: 100%; top: 0px; right: 0px; bottom: 0px;
                ...
                <table style="width: 100%; height: 100%;" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="height: 25px; color: #333333; font-family: Consolas, Georgia; font-size: 13px;
                        ...
                        <td style="padding-right: 8px; text-align: right;">
                            <asp:Label ID="lbl_CurrentPage" runat="server" Text="FINAL INSPECTION DISPLAY " />|
        ...
        <tr>
            ...
            <ul id="gn-menu" class="gn-menu-main" style="background-color: #1591cd !important;">
                 <%--<li>
                    <a href="#">  <asp:ImageButton ImageUrl="images/left-arrow%20(1).png" ID="back" runat="server" OnClick="btn_Back_Click" style="margin-top:15px;"></asp:ImageButton></a>
           </li>--%>
  ...
  <li style="border-left: 1px solid #c6d0da;"><a style="color: white;" href="#">
        ...
        <br />
            ...
            <ul id="gn-menu" class="gn-menu-main" style="background-color: #A62724 !important;">
                 <li>
                    <a href="NewJobCardCreation.aspx">  <asp:ImageButton ImageUrl="images/left-arrow%20(1).png" ID="back" runat="server" OnClick="back_Click" style="margin-top:15px;"></asp:ImageButton></a>
                </li>
                <li><a href="#" style="padding: 14px 34px;"><img src="images/wms--logo.png" /></a></li>
               ...
               <li style="width:250px;border-right:unset !important;"><i class="fa fa-clock-o" style="color:white"></i> &nbsp;&nbsp;<asp:Label class="" ID="lbl_currTime" Font-Bold="true" style="color: white;text-transform:uppercase !important" runat="server" ></asp:Label></li>


                <li style="border-right:unset !important;margin-left: 12px;"> <asp:Label ID="lbScroll0" ForeColor="White" Visible="false" runat="server"></asp:Label></li>
                 <li style="float:right;">  
                  <asp:LinkButton ID="btn_logout" OnClick="btn_logout_Click" style="vertical-align: middle;color:white;" Text="logout"  runat="server"></asp:LinkButton>
                  </li>            
                <li style="float:right;border-left: 1px solid #c6d0da;border-right: 1px solid #c6d0da;"><a style="color: white;" href="#">
