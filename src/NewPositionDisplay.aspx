<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewPositionDisplay.aspx.cs"
    Inherits="NewPositionDisplay" %>
...
<body>
                ...
                <tr class="smallFont">
                    <td>
                        <table class="fullStyle" bgcolor="Silver">
                            <tr>
                                <td style="width: 15%; padding-right: 10px;" align="left">
                                    <asp:Label ID="lblSyncTime" runat="server" Font-Size="Medium" ForeColor="#333333"></asp:Label>
                                </td>
                                <td style="width: 40%; height: 25px;" align="right">
                                    <asp:Label ID="lbl_CurrentPage" runat="server" ForeColor="#333333" Text="Position Display"></asp:Label>
                                </td>
                                <td style="width: 45%;" align="right">
                                    <asp:Label ID="lbl" runat="server" Text="Service Advisor:" ForeColor="#333333"></asp:Label>
                                    <asp:Label ID="lblSAName" runat="server" Visible="true" ForeColor="#333333"></asp:Label>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="border-color: #333333; background-color: Silver; width: 100%; color: #333333;
                text-align: center;" border="0" cellspacing="0" cellpadding="0">
                <tr style="font-size: 12px; height: 30px; font-family=consolas, georgia">
                    <td>
                        ...
                        <div id="Waiting" runat="server">
                            ...
                            <div class="divblock" style="width: 100%;">
                                ...
                                <asp:SqlDataSource ID="srcWaiting" runat="server" ConnectionString="<%$ ConnectionStrings:ProTRAC_ConnectionString %>"
                                    SelectCommand="GetVehiclePositionInfo_SA" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="hfWaiting" DefaultValue="Gate" Name="Position" PropertyName="Value"
                                            Type="String" />
                                        <asp:ControlParameter ControlID="lblSAName" DefaultValue="" Name="SAName" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </div>
                        </div>
                ...
                <tr>
                    <td valign="top" align="center" style="width: 25%;">
                        ...
                        <asp:SqlDataSource ID="srcIdle1" runat="server" ConnectionString="<%$ ConnectionStrings:ProTRAC_ConnectionString %>"
                            SelectCommand="GetVehicleIdlePositionInfo_SA" SelectCommandType="StoredProcedure">
                            <SelectParameters>
