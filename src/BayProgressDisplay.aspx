<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BayProgressDisplay.aspx.cs"
    Inherits="BayProgressDisplay" %>
            ...
            <td colspan="3" valign="top">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" style="width: auto; height: 100%">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="timeLinePnl" runat="server" Height="100%" Width="100%" ScrollBars="Auto">
                            <asp:GridView ID="timeLine" runat="server" CellPadding="4" ForeColor="#333333" OnRowDataBound="timeLine_RowDataBound"
                                AllowPaging="True" PageSize="16" Width="100%" HeaderStyle-BackColor="#00376F">
                                <RowStyle BackColor="WhiteSmoke" Font-Names="Consolas, Georgia" Wrap="False" />
        ...
        <tr style="background-color: Black; height: 35px">
            <td style="background-color: Black; vertical-align: top;" colspan="2" align="center">
                <marquee>
                  ...
                  Font-Size="Large" Font-Names="Consolas, Georgia" Text="Vehicle On Hold" Font-Bold="True"></asp:Label>
                 </marquee>
            </td>
