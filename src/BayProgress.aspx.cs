...
public partial class BayProgress : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (Session[Session["CVDealercode"] + "-CVConString"].ToString() == null || Session[Session["CVDealercode"] + "-CVConString"].ToString() == "")
            {
    ...
    public string getVersion()
    {
        ...
        SqlConnection con = new SqlConnection(Session[Session["CVDealercode"] + "-CVConString"].ToString());
    ...
    private void createTab()
    {
        try
        {
            SqlConnection dbaseCon = new SqlConnection(Session[Session["CVDealercode"] + "-CVConString"].ToString());
    ...
    {
        using (SqlConnection con = new SqlConnection(Session[Session["CVDealercode"] + "-CVConString"].ToString()))
        {
            con.Open();
