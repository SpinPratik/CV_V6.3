<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true"
    CodeFile="IdleTime_Bodyshop.aspx.cs" Inherits="IdleTime_Bodyshop" Title="IdleTime_Bodyshop" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="grvIdelTime" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    OnRowCommand="grvIdelTime_RowCommand" CssClass="mydatagrid" Width="100%" OnRowDataBound="grvIdelTime_RowDataBound">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                    <Columns>
                          <asp:BoundField DataField="Id" HeaderText="ProcessId" InsertVisible="False"
                        ...
                        <asp:TemplateField HeaderText="Process Time" SortExpression="EscalationTime">
                            <ItemTemplate>
                                <asp:TextBox ID="txtprocessTime" CssClass="form-control" runat="server" MaxLength="4" Text='<%# Bind("ProcessTime") %>' onkeypress="return isNumberKey(event)"/>
                            </ItemTemplate>
                        </asp:TemplateField>

                      
                        <asp:ButtonField Text="Update" CommandName="Update_EscalationTime"  />
                    </Columns>
