<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BayDisplayKM.aspx.cs" Inherits="BayDisplayKM" %>
        ...
        <tr style="background-color: Black; height: 40px">
            <td style="background-color: Black; vertical-align: top;" colspan="2" align="center">
               <%-- <marquee>--%>
                  ...
                  Font-Size="Larger" Font-Names="Consolas, Georgia" Text="Bay Progress Display" Font-Bold="True"></asp:Label>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <asp:Label ID="L2" runat="server"  ForeColor="White" BackColor="Black"
                  Font-Size="Larger" Font-Names="Consolas, Georgia" Text="Work In Progress" Font-Bold="True"></asp:Label>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <asp:Label ID="Label2" runat="server"  ForeColor="Green" BackColor="Black"
                  Font-Size="Larger" Font-Names="Consolas, Georgia" Text="Work Completed" Font-Bold="True"></asp:Label>
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
