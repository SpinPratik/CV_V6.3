<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobAllotment_TeamLeadWise.aspx.cs" Inherits="JobAllotment_TeamLeadWise" EnableViewStateMac="false" EnableSessionState="True" EnableEventValidation="false" ValidateRequest="false" ViewStateEncryptionMode="Never"%>
    ...
    <table style="position: fixed; width: 100%; height: 100%; top: 0px; right: 0px; bottom: 0px;
        ...
        <tr>
                                    ...
                                    <td>
                                        <tr>
                                            ...
                                            <td class="style10" align="left">
                                                <asp:TextBox ID="tbAllotDate" Text="" runat="server" Width="90px"  ontextchanged="tbAllotDate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            ...
                                            <td valign="middle" width="110px">
                                              ...
                                              <%--   AutoPostBack="True"
                                                     OnSelectedIndexChanged="ddlShift_SelectedIndexChanged" DataSourceID="DS_Shift" DataTextField="Shift" DataValueField="ShiftID"--%>
                                            </td>
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle; font-family: Consolas, Georgia;
                                            ...
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle;" bgcolor="WhiteSmoke"
                                               ...
                                               <%-- <asp:DropDownList ID="ddlTeam" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                                  ...
                                                  <asp:DropDownList ID="ddlBay" runat="server" AppendDataBoundItems="True" DataTextField="BayName"
                                                    DataValueField="BayId" Width="95px" 
                                                    Font-Names="Consolas, Georgia">
                                                    <asp:ListItem Value="0">Bay</asp:ListItem>
                                                </asp:DropDownList>
                                               <%--  AutoPostBack="True" OnSelectedIndexChanged="ddlBay_SelectedIndexChanged"--%>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle; font-family: Consolas, Georgia;"
                                                bgcolor="WhiteSmoke" class="style10">
                                                 Employee Type
                                            </td>
                                            <td valign="middle" width="130px" colspan="2">
                                                <asp:DropDownList ID="ddlEmpType" runat="server" AutoPostBack="True" Width="91%"
                                            ...
                                            <td valign="middle" width="110px" colspan="2">
                                                <asp:DropDownList ID="cmbTechName" runat="server" Width="98%" AppendDataBoundItems="True"
                                        ...
                                        <tr>
                                            ...
                                            <td class="style10" valign="middle">
                                                ...
                                                <cc1:AutoCompleteExtender ID="tbJobCode_AutoCompleteExtender" runat="server" CompletionInterval="1"
                                                 ...
                                                 <asp:DropDownList ID="drpJobCode" runat="server" AppendDataBoundItems="True" DataTextField="JobCode"
                                                    DataValueField="JobCode" Width="95px" OnSelectedIndexChanged="tbJobCode_TextChanged"
                                            ...
                                            <td><asp:Button CssClass="button" ID="btn_AddJobCard" runat="server" 
                                                    Text="Add New" onclick="btn_AddJobCard_Click"/></td>
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle; font-family: Consolas, Georgia;"
                                                bgcolor="WhiteSmoke" class="style10" width="70px">
                                                Job Description
                                            </td>
                                            <td style="white-space: nowrap; vertical-align: middle;" bgcolor="WhiteSmoke" class="style10"
                                                width="100%" colspan="2" >
                                                <asp:TextBox ID="tbJobDesc" runat="server" Width="96%" Text="" OnTextChanged="tbJobDesc_TextChanged"
                                                    AutoPostBack="True"></asp:TextBox>
                                                <cc1:AutoCompleteExtender ID="AutoCompleteExtender5" runat="server" CompletionInterval="1"
                                                    CompletionListItemCssClass="AutoCompStyle1" CompletionListCssClass="AutoComStyle2"
                                                    CompletionListHighlightedItemCssClass="AutoComStyle3" Enabled="True" ServiceMethod="GetCompletionList1"
            ...
            <td valign="top">
               ...
               <asp:Panel runat="server" ID="timeLinePnl" Height="500px" CssClass="commonFont" Width>
