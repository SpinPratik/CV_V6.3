...
public partial class GMDisplayWorks : System.Web.UI.Page
{
    private static string BackTo = "";
    private static List<TMLGMDisplay> DisplayDt;
    private static string EmpId = "0";
    private static int fblank = 0;
    private static int miniTabIndex = 6;
    private static string statusVal = "";
    private static string RegNo = ""; //Declaration for Lost Customer
    private static int LostCusCount = 0;//Declaration for Lost Customer
    ...
    protected void LostCust() // For the Lost Customer
    {
    ...
    {
         DisplayDt = new List<TMLGMDisplay>();
        List<TMLGMDisplay> HDt = new List<TMLGMDisplay>();
        DisplayDt.Clear();
        DisplayDt = GetGMDisplayData(rbType.SelectedValue, txtVehicleNumber.Text, miniTabIndex + 1,txtTagNo.Text);
        HDt = DisplayDt;
        ...
        else
        {
            ...
            GridView1.DataSource = DisplayDt;
            GridView1.DataBind();
    ...
    protected void btn_Back_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else if (Session["ROLE"].ToString() == "DISPLAY" && Request.Url.ToString().Contains("GMDisplayWorks.aspx") && Session["BACKROLE"].ToString() == "GMSERVICE")
        {
    ...
    protected void btnLoad_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                List<TMLGMDisplay> Dt = new List<TMLGMDisplay>();
                Dt = GetGMDisplayData(rbType.SelectedValue, txtVehicleNumber.Text, miniTabIndex + 1, txtTagNo.Text);
    ...
    protected void grdDisplay_RowDataBound(object sender, GridViewRowEventArgs e)
    {
		...
		e.Row.Cells[17].Visible = false;
            ...
            {
                //e.Row.Cells[2].Text = "<div style='width:80px;height:42px;TEXT-ALIGN: center;'><table style='width:100%;Height:100%;' border='0' cellpadding='0' cellspacing='0'><tr><td style=height:50%;>VRN</td></tr><tr><td>VIN</td></tr></table></div>";
                //e.Row.Cells[3].Text = "<div style='width:30px;height:42px'><table style='width:100%;Height:100%;' border='0' cellpadding='0' cellspacing='0'><tr><td style=height:50%;>JDP</td></tr><tr><td>W&T</td></tr></table></div>";
                e.Row.Cells[0].Text = "<div style=text-align:center;>" + e.Row.Cells[0].Text.ToString() + "</div>";
                e.Row.Cells[1].Text = "<div style='text-align:center;padding-left:10px;'>" + e.Row.Cells[1].Text.ToString() + "</div>";
                //e.Row.Cells[7].Text = "<div style='width:30px;height:42px 99'><table style='width:100%;Height:100%;' border='0' cellpadding='0' cellspacing='0'><tr><td style=height:50%;>REPAIR</td></tr><tr><td>ORDER</td></tr></table></div>";
                e.Row.Cells[2].Text = "<div style=width:60px;text-align:left;padding-left:30px;>" + e.Row.Cells[2].Text.ToString() + "</div>";
                e.Row.Cells[3].Text = "<div style=text-align:center;padding-left:5px;>JDP</div>";
                e.Row.Cells[4].Text = "<div style=text-align:left;padding-left:5px;>" + e.Row.Cells[4].Text.ToString() + "</div>";
                e.Row.Cells[5].Text = "<div style=text-align:left;>" + e.Row.Cells[5].Text.ToString() + "</div>";
                e.Row.Cells[6].Text = "<div style=text-align:right;>" + e.Row.Cells[6].Text.ToString() + "</div>";
                e.Row.Cells[7].Text = "<div style=text-align:center;padding-left:20px;>" + e.Row.Cells[7].Text.ToString() + "</div>";
                e.Row.Cells[8].Text = "<div style=text-align:left;> " + e.Row.Cells[8].Text.ToString() + "</div>";

                e.Row.Cells[9].Text = "<div style=text-align:left;>" + e.Row.Cells[9].Text.ToString() + "</div>";
                e.Row.Cells[10].Text = "<div style=text-align:left;>" + e.Row.Cells[10].Text.ToString() + "</div>";
                e.Row.Cells[11].Text = "<div style=text-align:left;padding-left:10px;>" + e.Row.Cells[11].Text.ToString() + "</div>";
                e.Row.Cells[12].Text = "<div style=text-align:left;padding-left:10px;>" + e.Row.Cells[12].Text.ToString() + "</div>";
                e.Row.Cells[13].Text = "<div style=text-align:left;>" + e.Row.Cells[13].Text.ToString() + "</div>";
                e.Row.Cells[14].Text = "<div style=text-align:left;padding-right:10px;>" + e.Row.Cells[14].Text.ToString() + "</div>";
                e.Row.Cells[15].Text = "<div style=text-align:left;>" + e.Row.Cells[15].Text.ToString() + "</div>";
                e.Row.Cells[16].Text = "<div style=text-align:left;>" + e.Row.Cells[16].Text.ToString() + "</div>";
                e.Row.Cells[17].Text = "<div style=text-align:left;>" + e.Row.Cells[17].Text.ToString() + "</div>";
                e.Row.Cells[18].Text = "<div style=text-align:left;>" + e.Row.Cells[18].Text.ToString() + "</div>";
                ...
                e.Row.Cells[21].Text = "<div style=text-align:left;>" + e.Row.Cells[21].Text.ToString() + "</div>";
                e.Row.Cells[22].Text = "<div style=text-align:center;>" + e.Row.Cells[22].Text.ToString() + "</div>";
                e.Row.Cells[24].Text = "<div style=text-align:center;>" + e.Row.Cells[24].Text.ToString().ToUpper() + "</div>";
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (e.Row.Cells[2].Text.Length > 10)
                {
                    ...
                    e.Row.Cells[2].Text = "<div style=width:60px;text-align:left;>" + cells + "</div>";
                }

                else if (LostCusCount > 0)
                {
                    string sConnString = Session[Session["TMLDealercode"] + "-TMLConString"].ToString();
                    SqlConnection con = new SqlConnection(sConnString);
                    SqlDataAdapter sda = new SqlDataAdapter("select RegistrationNo from tbl_UploadLostCustomers", con);
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            if (RegNo == e.Row.Cells[2].Text.ToString())
                            {
                                e.Row.Cells[2].Text = "<div style=width:60px;text-align:left;>" + e.Row.Cells[2].Text.ToString() + "</div>";
                ...
                try
                {
                    if (e.Row.Cells[3].Text.ToString() == "0-0")
                        ...
                        e.Row.Cells[3].Text = "<div style=width:50px;><img src='images/JCR/JDP.png' Alt=''  width='16' height='16'/></div>";
                    else if (e.Row.Cells[3].Text.ToString() == "0-1")
                        e.Row.Cells[3].Text = "<div style=width:50px;><img src='images/JCR/Customer Waiting.png' Alt=''  width='16' height='16'/></div>";
                    else if (e.Row.Cells[3].Text.ToString() == "1-1")
                        e.Row.Cells[3].Text = "<div style=width:50px;><img src='images/JCR/JDP Customer Waiting.png' Alt=''  width='16' height='16'/></div>";
                }
                catch (Exception ex)
                {
                }
                ...
                try
                {
                    ...
                    if (e.Row.Cells[4].Text.Length > 10)
                        e.Row.Cells[4].Text = "<div style=text-align:left;>" + e.Row.Cells[4].Text.ToString().Substring(0, 10) + "</div>";
                    else
                        e.Row.Cells[4].Text = "<div style=text-align:left;>" + e.Row.Cells[4].Text.ToString() + "</div>";
                }
                catch (Exception ex)
                {
                }
                ...
                {
                    e.Row.Cells[8].Text = "<div style=width:40px;height=24px></div>";
                }
                else if (e.Row.Cells[8].Text.ToString().Trim() == "1")
                {
                    e.Row.Cells[8].Text = "<div style=width:40px;><img src='images/Red.png' Alt=''  width='16' height='16'/></div>";
                }
                else if (e.Row.Cells[8].Text.ToString().Trim() == "2")
                {
                    e.Row.Cells[8].Text = "<div style=width:40px;><img src='images/Light.png' Alt=''  width='16' height='16'/></div>";
                }
                else if (e.Row.Cells[8].Text.ToString().Trim() == "3")
                {
                    e.Row.Cells[8].Text = "<div style=width:40px;><img src='images/Green.png' Alt=''  width='16' height='16'/></div>";
                }
                else if (e.Row.Cells[8].Text.ToString().Trim() == "4")
                {
                    e.Row.Cells[8].Text = "<div style=width:40px;> <img id='animg' src='images/Yellow With Near.png' Alt='' width='16' height='16'/></div>";
                }
                ...
                try
                {
                    ...
                    if (status == "0")
                        e.Row.Cells[9].Text = "<div style=width:30px;padding-left:10px></div>";
                    else if (status == "1")
                        e.Row.Cells[9].Text = "<div style=width:30px;padding-left:10px><img src='images/JCR/JA ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    else if (status == "2")
                        e.Row.Cells[9].Text = "<div style=width:30px;padding-left:10px><img src='images/JCR/JA DELAY.png' Alt=''  width='16' height='16'/></div>";
                }
                catch (Exception ex)
                {
                }
                ...
                try
                {
                    ...
                    if (status == "0")
                    {
                        ...
                        if (StatusTech == "0")
                            ...
                            e.Row.Cells[10].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_ALLOT.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "1")
                    {
                        e.Row.Cells[10].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "2")
                    {
                        if (blinkflag == 1)
                            e.Row.Cells[10].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_NEAR.png' Alt='' width='16' height='16'/></div>";
                        else
                            e.Row.Cells[10].Text = "<div style='width:40px;'><img id='animg' src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_NEAR.png' Alt='' width='16' height='16'/></div>";
                    }
                    else if (status == "3")
                    {
                        e.Row.Cells[10].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_DELAY.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "4")
                    {
                    ...
                    {
                        e.Row.Cells[10].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/OutSkipped.png' Alt='' width='16' height='16'/></div>";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    if (status == "0")
                    {
                        if (Convert.ToInt16(StatusTech) > 1)
                            e.Row.Cells[11].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_ALLOT.png' Alt=''  width='16' height='16'/></div>";
                        else
                            e.Row.Cells[11].Text = "<div style='width:40px;'></div>";
                    }
                    else if (status == "1")
                    {
                        e.Row.Cells[11].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "2")
                    {
                        if (blinkflag == 1)
                            e.Row.Cells[11].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_NEAR.png' Alt='' width='16' height='16'/></div>";
                        else
                            e.Row.Cells[11].Text = "<div style='width:40px;'><img id='animg' src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_NEAR.png' Alt='' width='16' height='16'/></div>";
                    }
                    else if (status == "3")
                    {
                        e.Row.Cells[11].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_DELAY.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "4")
                    {
                    ...
                    {
                        e.Row.Cells[11].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    if (status == "0")
                    {
                        if (Convert.ToInt16(StatusTech) > 2)
                            e.Row.Cells[12].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_ALLOT.png' Alt=''  width='16' height='16'/></div>";
                        else
                            e.Row.Cells[12].Text = "<div style='width:40px;'></div>";
                    }
                    else if (status == "1")
                    {
                        e.Row.Cells[12].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "2")
                    {
                        if (blinkflag == 1)
                            e.Row.Cells[12].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_NEAR.png' Alt='' width='16' height='16'/></div>";
                        else
                            e.Row.Cells[12].Text = "<div style='width:40px;'><img id='animg' src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_NEAR.png' Alt='' width='16' height='16'/></div>";
                    }
                    else if (status == "3")
                    {
                        e.Row.Cells[12].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/TECH_WIP_DELAY.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "4")
                    {
                    ...
                    {
                        e.Row.Cells[12].Text = "<div style='width:40px;'><img src='https://res.cloudinary.com/deekyp5bi/image/upload/v1484205140/jcr/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    if (e.Row.Cells[13].Text.ToString().Contains('*'))
                    {
                        ...
                        if (status == "0")
                            if (e.Row.Cells[13].Text.ToString().Contains('$'))
                                e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/NotRequired.png' Alt=''  width='16' height='16'/></div>";
                            else
                                e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/WA allot.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "1")
                            e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/WA WIP.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "2")
                            e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/WA WIP NEAR.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "3")
                            e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/WA WIP Delay.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "4")
                            e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "5")
                            e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "6")
                            e.Row.Cells[13].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else
                    {
                        status = e.Row.Cells[13].Text.ToString().Substring(0, 1);
                ...
                try
                {
                    ...
                    {
                        e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/RT ONTIME.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else if (status == "4" || status == "5")
                    {
                        if (counter == "1")
                        {
                            e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (counter == "2")
                        {
                            e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/CN2.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (counter == "3")
                        {
                            e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/CN3.png' Alt=''  width='16' height='16'/></div>";
                        }
                    }
                    else if (status == "6")
                    {
                        e.Row.Cells[14].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    if (e.Row.Cells[15].Text.ToString().Contains('*'))
                    {
                        ...
                        {
                            if (e.Row.Cells[15].Text.ToString().Contains('$'))
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/NotRequired.png' Alt=''  width='16' height='16'/></div>";
                            else
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/WASH allot.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "1")
                        {
                            e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/WASH WIP.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "2")
                        {
                            e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/WASH WIP NEAR.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "3")
                        {
                            e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/WASH WIP Delay.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "4")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='18'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CN2.png' Alt=''  width='16' height='18'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CN3.png' Alt=''  width='16' height='18'/></div>";
                            }
                        }
                        else if (status == "5")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='18'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CR2.png' Alt=''  width='16' height='18'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/CR3.png' Alt=''  width='16' height='18'/></div>";
                            }
                        }
                        else if (status == "6")
                        {
                            e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                        }
                    }
                    else
                    {
                        ...
                        if (status == "0")
                        {
                            if (e.Row.Cells[15].Text.ToString().Contains('$'))
                                ...
                                e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/WASH.png' Alt=''  width='16' height='16'/></div>";
                        }
                        else if (status == "1")
                        {
                            e.Row.Cells[15].Text = "<div style=width:30px;><img src='images/JCR/WASH WIP.png' Alt=''  width='16' height='16'/></div>";
                ...
                try
                {
                    ...
                    if (repeatStatus == 0)
                    {
                        ...
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/QC WIP.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "2")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/QC WIP Near.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "3")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/QC WIP Delay.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "4")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CN2.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CN3.png' Alt='' width='16' height='16'/></div>";
                            }
                        }
                        else if (status == "5")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CR2.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CR3.png' Alt='' width='16' height='16'/></div>";
                            }
                        }
                        else if (status == "6")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt='' width='16' height='16'/></div>";
                        }
                    }
                    else
                    {
                        ...
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/QC WIPR.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "2")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/QC WIP NearR.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "3")
                        {
                            e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/QC WIP DelayR.png' Alt='' width='16' height='16'/></div>";
                        }
                        else if (status == "4")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CNR.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CNR2.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CNR3.png' Alt='' width='16' height='16'/></div>";
                            }
                        }
                        else if (status == "5")
                        {
                            if (counter == "1")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CRR.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "2")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CRR2.png' Alt='' width='16' height='16'/></div>";
                            }
                            else if (counter == "3")
                            {
                                e.Row.Cells[16].Text = "<div style=width:30px;><img src='images/JCR/CRR3.png' Alt='' width='16' height='16'/></div>";
                            }
                        }
                        else if (status == "6")
                        {
                ...
                try
                {
                    ...
                    if (e.Row.Cells[17].Text.ToString().Contains('*'))
                    {
                        ...
                        if (status == "0")
                            if (e.Row.Cells[17].Text.ToString().Contains('$'))
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/NotRequired.png' Alt=''  width='16' height='16'/></div>";
                            else
                                e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/PK4.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "1")
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/PK.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "2")
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/PK1.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "3")
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/PK3.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "4")
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='18'/></div>";
                        else if (status == "5")
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='18'/></div>";
                        else if (status == "6")
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                    else
                    {
                        status = e.Row.Cells[17].Text.ToString().Substring(0, 1);
                        if (status == "0")
                            ...
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CN.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "5")
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/CR.png' Alt=''  width='16' height='16'/></div>";
                        else if (status == "6")
                            e.Row.Cells[17].Text = "<div style=width:30px;><img src='images/JCR/OutSkipped.png' Alt=''  width='16' height='16'/></div>";
                    }
                }
                ...
                try
                {
                    ...
                    {
                        e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/JCC SKIP.png' Alt=''  width='16' height='16'/></div>";
                        e.Row.Cells[18].ToolTip = "Closed but not informed [" + jcc_str[1].Trim() + "]";
                    }
                    else if (jcc_str[0] == "1-1")
                    {
                        e.Row.Cells[18].Text = "<div style=width:30px;><img src='images/JCR/JCC ONTIME.png' Alt=''  width='16' height='16'/></div>";
                ...
                try
                {
                    ...
                    if (e.Row.Cells[19].Text.ToString() == "0")
                        ...
                        e.Row.Cells[19].Text = "<div style=width:20px;><img src='images/JCR/circle_green.png' Alt=''  width='14' height='14'/></div>";
                    else if (e.Row.Cells[19].Text.ToString() == "2")
                        e.Row.Cells[19].Text = "<div style=width:20px;><img src='images/JCR/circle_yellow.png' Alt=''  width='14' height='14'/></div>";
                    else if (e.Row.Cells[19].Text.ToString() == "3")
                        e.Row.Cells[19].Text = "<div style=width:20px;><img src='images/JCR/circle_red.png' Alt=''  width='14' height='14'/></div>";
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    else  if (e.Row.Cells[20].Text.ToString().Contains('@'))
                    {
                        if (e.Row.Cells[20].Text.ToString().Contains('Y'))
                        {
                            e.Row.Cells[20].Text = "<div Id='animg' style=width:65px;color:BLUE;>" + e.Row.Cells[20].Text.Replace('@', ' ').Replace('Y', ' ').ToString().Trim() + "</div>";
                        }
                        else
                        {
                            e.Row.Cells[20].Text = "<div Id='animg' style=width:65px;color:RED;>" + e.Row.Cells[20].Text.Replace('@', ' ').Replace('N', ' ').ToString().Trim() + "</div>";
                        }
                    }
                    else
                    {
                ...
                try
                {
                    if (e.Row.Cells[22].Text.Trim() == "1" || e.Row.Cells[22].Text.Trim() == "2")
                    {
                    ...
                    if (e.Row.Cells[22].Text.ToString() == "0")
                        ...
                        e.Row.Cells[22].Text = "<div style=width:30px;><img src='images/JCR/REMARKS ENTRY.png' Alt=''  width='16' height='16'/></div>";
                    else
                        e.Row.Cells[22].Text = "<div style=width:30px;><img src='images/JCR/REMARKS ENTRY_Green.png' Alt=''  width='16' height='16'/></div>";
                }
                catch (Exception ex)
                { }
                ...
                try
                {
                    ...
                    if (e.Row.Cells[24].Text != "")
                    {
                        ...
                        else
                        {
                            if (Convert.ToDateTime(e.Row.Cells[24].Text).ToString("dd/MM") != DateTime.Now.ToString("dd/MM"))
                            {
                                e.Row.Cells[24].Text = "<div style='color:red'>" + Convert.ToDateTime(e.Row.Cells[24].Text).ToString("HH:mm d/M") + "</div>";
                            }
                            else
                            {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Session["ROLE"] == null || Session["ROLE"].ToString() != "WORK MANAGER" && Session["ROLE"].ToString() != "FRONT OFFICE" && Session["ROLE"].ToString() != "SERVICE ADVISOR" && Session["ROLE"].ToString() != "CRM" && Session["ROLE"].ToString() != "DISPLAY" && Session["ROLE"].ToString() != "GMSERVICE" && Session["ROLE"].ToString() != "SM")
            {
                Response.Redirect("login.aspx");
            }
        }
            ...
            try
            {
                ...
                if (!(Request.Form["_EventTarget"] != null && Request.Form["_EventTarget"] == "myClick"))
                {
                    ...
                    if (grdDisplay.SelectedRow.Cells[1].Text.Replace("&nbsp;", "").Trim().Replace("<div style=width:26px;>", "").Replace("</div>", "") != "")
                    {
                        ...
                        lblSlnoForGMR.Text = grdDisplay.SelectedRow.Cells[23].Text.Replace("&nbsp;", "").Trim();
    ...
    private List<TMLGMDisplay> GetGMDisplayData(string Type, string vehiclenumber, int param, string TagNumber)
    {
        ...
        cmd.Parameters.Clear();
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "JCDisplayI_GM"; // JobControllerDisplayI
        ...
        List<TMLGMDisplay> GmDisp = new List<TMLGMDisplay>();
        while (dr.Read())
        {
            GmDisp.Add(new TMLGMDisplay{
    ...
    //    string str = "<span><table class='mydatagrid' id=InOutPnl style=width:100%;><tr style=text-align:center;color:#A62724;font-weight:bold;><th colspan=2 style=color:#A62724;font-weight:bold;>&nbsp;&nbsp;" + Tech + ": " + EmpName + "</th></tr><tr><td style=width:90px;>In Time: </td><td style=text-align:center;>" + inTime + "</td></tr><tr><td style=width:50px;>Out Time: </td><td style=text-align:center;>" + outTime + "</td></tr></table></span>";
    //    return str;
    //}
    ...
    //    string str = "<span><table class='mydatagrid' id=InOutPnl style=width:100%;><tr style=text-align:center;font-weight:bold;><th colspan=2 style=color:#A62724;font-weight:bold;>&nbsp;&nbsp;" + ProcessName + "  " + empName + "</th></tr><tr><td style=width:90px;>In Time: </td><td style=text-align:center;>" + inTime + "</td></tr><tr><td style=width:50px;>Out Time: </td><td style=text-align:center;>" + outTime + "</td></tr></table></span>";
    //    return str;
    //}
    ...
    //    if (tt7 == "Delivered")
    //        str = "<span><table class='mydatagrid'><tr><td style='color:#a62724;font-weight:800;'>CUSTOMER NAME</td><td>:</td><td>" + tt3 + "</td></tr><tr style='height:18px'><td style='color:#a62724;'>CONTACT NO</td><td>:</td><td>" + tt4 + "</td></tr><tr style='height:18px'><td style='color:#a62724;font-weight:bold;'>IN TIME</td><td>:</td><td>" + tt6 + "</td></tr><tr style='height:18px'><td style='color:#a62724;'>SA NAME</td><td>:</td><td>" + tt11 + "</td></tr><tr style='height:18px'><td style='color:#a62724;'>STAGE</td><td>:</td><td>" + tt7 + "</td></tr><tr style='height:18px'><td style='color:#a62724;'>OUT TIME</td><td>:</td><td>" + tt16 + "</td></tr><tr style='height:18px'><td style='color:a62724;'>KMS</td><td>:</td><td>" + tt10 + "</td></tr></table></span>";
    //    else
    //        str = "<span><table class='mydatagrid'><tr><td style='color:#a62724;font-weight:800;'>CUSTOMER NAME</td><td>:</td><td>" + tt3 + "</td></tr><tr style='height:18px'><td style='color:#a62724;'>CONTACT NO</td><td>:</td><td>" + tt4 + "</td></tr><tr style='height:18px'><td style='color:#a62724;font-weight:bold;'>IN TIME</td><td>:</td><td>" + tt6 + "</td></tr><tr style='height:18px'><td style='color:#a62724;'>SA NAME</td><td>:</td><td>" + tt11 + "</td></tr><tr style='height:18px'><td style='color:#a62724;'>STAGE</td><td>:</td><td>" + tt7 + "</td></tr><tr style='height:18px'><td style='color:#a62724;'>KMS</td><td>:</td><td>" + tt10 + "</td></tr></table></span>";
    //    return str;
    //}
    ...
    public static string LoadRemarks(string RefNo)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            str = "<span><table class='mydatagrid' style=width:300px;><tr style=text-align:center;color:#a62724 !important;text-transform:unset !important;font-weight:bold;><th style=color:#a62724 !important;>&nbsp;&nbsp;Time</th><th style=color:#a62724 !important;>&nbsp;&nbsp;Remarks</th></tr>";
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                str += "<tr><td style=white-space:no-wrap;>" + dt.Rows[i][0].ToString().Replace("#", " ") + "</td><td style=white-space:no-wrap;>" + dt.Rows[i][1].ToString() + "</td></tr>";
            }
            str += "</table></span>";
        }
        else
    ...
    //    if (dt.Rows.Count > 0)
    //    {
    //        str = "<span><table class='mydatagrid'><tr style='color: #FFFFFF;'><td style='padding-left:3px;color:#a62724 !important;'><strong>PARTS NAME</strong></td><td style='width:50px;align:center;color:#a62724 !important;'><strong>STATUS</strong></td><td style='width:140px;align:center;color:#a62724 !important;'><strong>AVAILABILITY TIME</strong></td></tr>";
    //        for (int i = 0; i < dt.Rows.Count; i++)
    //        {
    //            if (i % 2 == 0)
    //            {
    ...
    //    string str = "<span><table class='mydatagrid' id=InOutPnl style=width:100%;><tr style=text-align:center;color:#A62724 !important;><th colspan=2 style=color:#A62724 !important;font-weight:bold;>&nbsp;&nbsp;" + SubProcessName + " : " + empName + "</th></tr><tr><td style=width:90px;>In Time: </td><td style=text-align:center;>" + inTime + "</td></tr><tr><td style=width:50px;>Out Time: </td><td style=text-align:center;>" + outTime + "</td></tr></table></span>";
    //    return str;
    //}
    ...
    protected void ImageButton5_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                SqlConnection con = new SqlConnection(sConnString);
                con.Open();
                SqlCommand cmd3 = new SqlCommand("InsertTblGMRemarks", con);
                cmd3.CommandType = CommandType.StoredProcedure;
                cmd3.Parameters.AddWithValue("@RefNo", lblSlnoForGMR.Text.ToString());
                cmd3.Parameters.AddWithValue("@Comment", txtremarks.Text.ToString());
                cmd3.Parameters.AddWithValue("@DTM",DateTime.Now);
                cmd3.ExecuteNonQuery();
                con.Close();
    ...
    protected void btn_logout_Click2(object sender, EventArgs e)
    {
