<%@ Page Title="Display" Language="C#" MasterPageFile="~/AdminModule.master" AutoEventWireup="true"
    CodeFile="DisplayHome_Backup.aspx.cs" Inherits="DisplayHome" %>
                ...
                <table style="width: 700px; height: 50px;" border="0" cellpadding="1" cellspacing="10">
                    ...
                    <tr>
                        <td align="center" height="160">
                            <asp:ImageButton ID="BtnBayDisplay" runat="server" Height="100%" Width="200px" ImageUrl="~/MenuImages/Bay Progress.png"
                        ...
                        <td align="center" height="160">
                            <asp:ImageButton ID="BtnCustomerDisplay" runat="server" Height="100%" Width="200px"
                                ImageUrl="~/MenuImages/Customer Display.png" ImageAlign="Middle" AlternateText="Customer Display"
                    ...
                    <tr>
                        ...
                        <td align="center" height="160">
                            <asp:ImageButton ID="BtnPositionDisplay" runat="server" Height="100%" Width="200px"
                                ImageUrl="~/MenuImages/Position Display.png" ImageAlign="Middle" AlternateText="Position Display"
                        ...
                        <td align="center" height="160">
                            <asp:ImageButton ID="BtnCustomerDisplay1" runat="server" Height="100%" Width="200px"
                                ImageUrl="~/MenuImages/Vehicle Status display.png" ImageAlign="Middle" AlternateText="Vehicle Status"
