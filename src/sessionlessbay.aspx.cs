...
public partial class Baydisplay : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if ("Data Source=52.172.222.80;Initial Catalog=SRT1_Auto;User ID=dbuser;Password=spin@1234;Connection TimeOut=1200000; Pooling=False;" == null || "Data Source=52.172.222.80;Initial Catalog=SRT1_Auto;User ID=dbuser;Password=spin@1234;Connection TimeOut=1200000; Pooling=False;" == "")
    ...
    protected void btn_logout_Click(object sender, EventArgs e) //Added by Pratik
    {
        Session.Clear();
        Session.Abandon();
        Response.Redirect("login.aspx");
    ...
    private void FillBayDisplay()
    {
        ...
        try
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=52.172.222.80;Initial Catalog=SRT1_Auto;User ID=dbuser;Password=spin@1234;Connection TimeOut=1200000; Pooling=False;");
