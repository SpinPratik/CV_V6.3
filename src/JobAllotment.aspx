<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobAllotment.aspx.cs" Inherits="JobAllotment" EnableViewStateMac="false" EnableSessionState="True" EnableEventValidation="false" ValidateRequest="false" ViewStateEncryptionMode="Never"%>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showRegNoHover(e, RefNo) {
            ...
            $.ajax({
                type: "POST",
                url: "JobAllotment.aspx/LoadRegNoHover",
                data: "{'RefNo':'" + RefNo + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
    ...
    <table style="position: fixed; width: 100%; height: 100%; top: 0px; right: 0px; bottom: 0px;
        ...
        <tr>
                            ...
                            <table cellpadding="0" cellspacing="3" width="300px" border="0">
                                    ...
                                    <td>
                                        <tr>
                                            ...
                                            <td class="style10" align="left">
                                                <asp:TextBox ID="tbAllotDate" Text="" runat="server" Width="75px" 
                                                    ontextchanged="tbAllotDate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            ...
                                            <td valign="middle" width="110px">
                                                <asp:DropDownList ID="ddlShift" runat="server" AppendDataBoundItems="True" 
                                                    ...
                                                    Width="90px" ToolTip="Shift" Font-Names="Consolas, Georgia">
                                                </asp:DropDownList>
                                                <%--OnSelectedIndexChanged="ddlShift_SelectedIndexChanged" AutoPostBack="True" DataSourceID="DS_Shift" DataTextField="Shift" DataValueField="ShiftID"--%>
                                            </td>
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle; font-family: Consolas, Georgia;
                                            ...
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle;" bgcolor="WhiteSmoke"
                                                ...
                                                <asp:DropDownList ID="ddlTeam" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                                    ...
                                                    Width="100px" ToolTip="Team-Lead" Font-Names="Consolas, Georgia">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" class="style10">
                                                <asp:DropDownList ID="ddlBay" runat="server" AppendDataBoundItems="True" DataTextField="BayName"
                                                    DataValueField="BayId" Width="80px"
                                                   Font-Names="Consolas, Georgia">
                                                    <asp:ListItem Value="0">Bay</asp:ListItem>
                                                </asp:DropDownList>
                                                <%-- OnSelectedIndexChanged="ddlBay_SelectedIndexChanged"   AutoPostBack="True" --%>
                                            </td>
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle; font-family: Consolas, Georgia;"
                                                bgcolor="WhiteSmoke" class="style10" width="70px">
                                                Emp Type
                                            ...
                                            <td valign="middle" width="110px">
                                                <asp:DropDownList ID="ddlEmpType" runat="server" AutoPostBack="True" Width="90px"
                                            ...
                                            <td valign="middle" width="110px">
                                             <%--  OnSelectedIndexChanged="cmbTechName_SelectedIndexChanged" AutoPostBack="True"--%>
                                                <asp:DropDownList ID="cmbTechName" runat="server" Width="100px" AppendDataBoundItems="True"
                                                     Font-Names="Consolas, Georgia" AutoPostBack="True" 
                                                    onselectedindexchanged="cmbTechName_SelectedIndexChanged" >
                                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                          <%--  <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style10" valign="middle">
                                                <asp:TextBox ID="tbJobCode" runat="server" Width="75px" Text="" OnTextChanged="tbJobCode_TextChanged"
                                                ...
                                                <cc1:AutoCompleteExtender ID="tbJobCode_AutoCompleteExtender" runat="server" CompletionInterval="1"
                                                 ...
                                                 <asp:DropDownList ID="drpJobCode" runat="server" AppendDataBoundItems="True" DataTextField="JobCode"
                                                    DataValueField="JobCode" Width="80px" OnSelectedIndexChanged="tbJobCode_TextChanged"
                                                    AutoPostBack="True" Font-Names="Consolas, Georgia" >
                                                    <asp:ListItem Value="JobCode">JobCode</asp:ListItem>
                                                </asp:DropDownList>
                                                
                                            </td>
                                              <td><asp:Button CssClass="button" ID="btn_AddJobCard" runat="server" 
                                                    Text="Add New" onclick="btn_AddJobCard_Click" Width="62px"/></td>
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle; font-family: Consolas, Georgia;"
                                                bgcolor="WhiteSmoke" class="style10" width="70px" align="center">
                                                Description
                                            </td>
                                            <td style="white-space: nowrap; vertical-align:middle;" bgcolor="WhiteSmoke" class="style10"
                                                width="100%" colspan="2" align="left">
                                                <asp:TextBox ID="tbJobDesc" runat="server" Width="75%" Text="" OnTextChanged="tbJobDesc_TextChanged"
                                                    AutoPostBack="True"></asp:TextBox>
                                                <cc1:AutoCompleteExtender ID="AutoCompleteExtender5" runat="server" CompletionInterval="1"
                                                    CompletionListItemCssClass="AutoCompStyle1" CompletionListCssClass="AutoComStyle2"
                                                    CompletionListHighlightedItemCssClass="AutoComStyle3" Enabled="True" ServiceMethod="GetCompletionList1"
                                                ...
                                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/Plus.png" 
                                                    Height="25px" onclick="ImageButton1_Click"/>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style10">
                                                <asp:TextBox ID="txtInTime" runat="server" Width="80px"></asp:TextBox>
                                            ...
                                            <td valign="top" align="left" style="white-space: nowrap; color: #333333; vertical-align: middle;"
                                                bgcolor="WhiteSmoke" width="80px">
                                                <asp:TextBox ID="tbAllotTime" runat="server" Width="60px" Enabled="false"></asp:TextBox>
                                                min.
                                            </td>
                                            <td style="white-space: nowrap; color: #333333; vertical-align: middle; font-family: Consolas, Georgia;
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" align="center" style="border: 1px solid #DFDFDF; white-space: nowrap;
                                        color: #333333;" bgcolor="WhiteSmoke" width="80px" height="20px">
                                ...
                                <td style="white-space: nowrap; color: #333333; vertical-align: middle; font-family: Consolas, Georgia;"
                                    ...
                                    <td valign="middle" align="center" style="border: 1px solid #DFDFDF; white-space: nowrap;
                                      ...
                                      <%--  <asp:TextBox ID="txtKMS" runat="server" Enabled="false"></asp:TextBox>--%>
                                        <asp:Label ID="lblCurrentKMS" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
          ...
          <%--  <td valign="top" style="width: 100%;">--%>
            ...
            <td valign="top">
                 <div style="width: 788px; overflow: auto;">
        <asp:Panel runat="server" ID="timeLinePnl" Height="500px" CssClass="commonFont">
