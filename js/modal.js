...
//        //this.border = "20px solid #ccc";
//        this.corners = 'Rounded';
//        this.className = null;
//        this.dragDrop = true;
//        this.height = 350;  // see also autoStretch
...
//            div.style.border = "6px solid #D6D6D6";
//            if (this.dragDrop) {
...
(function () {
    ...
    DayPilot.Modal = function () {
        ...
        this.className = null;
        this.dragDrop = true;
        this.height = 300;  // see also autoStretch
        this.maxHeight = null; // if not set, it will stretch until the bottom space is equal to this.top
        this.opacity = 30;
        this.scrollWithPage = true;  // modal window will scroll with the page
        this.top = 20;
