...
function ToolTip(id, isAnimated, aniSpeed) {
    ...
    this.Show = function (e, strHTML) {
        ...
        if (strHTML != null) {
            ...
            cntHight = $(actElement).css("hight");
            cntWidth = $(actElement).css("width");

            div.style.width = cntWidth;
            div.style.hight = cntHight;
        ...
        if (animateToolTip) {
            ...
            div.style.width = "0px";
            // ToolTip.animate(div.id,divHeight,divWidth);
            ToolTip.animate(div.id, cntHight, cntWidth);
        }
    }
