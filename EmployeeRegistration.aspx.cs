...
public partial class EmployeeRegistration : System.Web.UI.Page
{
    ...
    {
        if (cmbEType.SelectedValue == "1" && txtCRMUserId.Text.ToString() == "")
            lbMsg.Text = "Please Enter CRM User Id.";
        else
        {
            ...
            cmd1.Parameters.AddWithValue("@IsBodyshop", "0");
            cmd1.Parameters.AddWithValue("@CRMUserId", txtCRMUserId.Text.ToString());
            cmd1.Parameters.AddWithValue("@PhoneNo", txtPhoneNo.Text.ToString());
           ...
           // chkIsBodyShop.Checked = false;
            ...
            else
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (dt.Rows[0]["EmpType"].ToString() == "1")
                    {
                        txtCRMUserId1.Enabled = true;
                        txtCRMUserId1.Text = dt.Rows[0]["CRMUserId"].ToString();
                        txtPhoneNo1.Enabled = true;
                        txtPhoneNo1.Text = dt.Rows[0]["PhoneNo"].ToString();
                    }
                    else
                        txtCRMUserId1.Enabled = false;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (ddlEmployeeType.SelectedValue == "1" && txtCRMUserId1.Text.ToString() == "")
                lbMsg1.Text = "Please Enter CRM User Id.";
            else
            {
                SqlConnection con = new SqlConnection(DataManager.ConStr);
                ...
                cmd.Parameters.AddWithValue("@CRMUserId", txtCRMUserId1.Text.ToString());
                cmd.Parameters.AddWithValue("@PhoneNo", txtPhoneNo1.Text.ToString());
    ...
    protected void cmbEType_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (cmbEType.SelectedValue == "1")
        {
            txtCRMUserId.Enabled = true;
