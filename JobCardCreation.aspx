<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule_New.master" AutoEventWireup="true"
    CodeFile="JobCardCreation.aspx.cs" Inherits="JobCardCreation" EnableViewStateMac="false" EnableSessionState="True" EnableEventValidation="false" ValidateRequest="false" ViewStateEncryptionMode="Never"%>
        ...
        <asp:Button CssClass="btn btn-info" Style="float: right; border: 1px solid #286090; color: #286090; font-weight: 800; font-size: 12px; font-family: tahoma, arial, Verdana; background-color: white;" Text="service advisor display" ID="btn_displaylink" OnClick="btn_displaylink_Click" runat="server" />
                        ...
                        <div class="chats-blk">
                            <div class="chart-options">
                                ...
                                <ul class="MyTabStyle list-inline nav nav-pills" style="color: black;float:left">
                                    <li class="MyTabStyle  ac-graph-home active"><a data-toggle="pill" style="background-color: none;" href="#container3"> JOB CARD</a></li>
                                    <li class="MyTabStyle ac-graph-home"><a data-toggle="pill" style="background-color: none;" href="#container1"> EDIT VRN/VIN</a></li>
                                    <li class="MyTabStyle ac-graph-home"><a data-toggle="pill" style="background-color: none;" href="#container"> EDIT CUSTOMER DETAILS</a></li>
                                    
                                </ul>
                            </div>

                            <div class="tab-content" >
                                <div id="container3" class="tab-pane fade in active">
                    ...
                    <tr>
                        <td align="center">
                            <table style="width: 100%;">
                                        ...
                                        <table style="vertical-align: top; width: 100%;">
                                            ...
                                            <tr class="clmDistriSmall">
                                                ...
                                                <td valign="top">
                                                    ...
                                                    <div class="wrapper">
                                                       ...
                                                       <%-- <asp:ImageButton CssClass="button1" ID="btn_Searchcd" runat="server" ImageUrl="~/img/search_2.png" OnClick="btn_Searchcd_Click"
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" >&nbsp;<asp:Button ID="btnAdd" runat="server" CssClass="btn btn-success" OnClick="btnAdd_Click"
                                                    Text="Open Repair Order" Title="" ValidationGroup="VAL" style="width:192px"></asp:Button>
                                                    &nbsp;<asp:Button
                                                    ...
                                                    <table class="commonFont">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 20px; padding-left: 5px;">
                                                              <%--  <asp:ImageButton ID="btnSrchTag" CssClass="btn btn-default" Style="margin-left: -48px; margin-top: 18px; position: relative;" runat="server" AlternateText="Search" ImageUrl="~/img/search_2.png"
                                                            ...
                                                            <td>
                                                              <%--  <asp:ImageButton ID="btnRefresh" runat="server" AlternateText="Refresh" Height="16px"
                                                                    ImageUrl="~/img/refresh.png" OnClick="btnRefresh_Click" style="margin-top: 22px; margin-left: -12px;" ></asp:ImageButton>--%>
                                ...
                                <div id="container1" class="tab-pane fade " style="height: 400px; width: 796px">
...
runat="server" Visible="False"></asp:Label></tr>
                    ...
                    <tr>
                        <td align="right">
                            ...
                            &nbsp;<asp:Button ID="btnecncl" runat="server" CssClass="btn btn-info" OnClick="btnecncl_Click" Text="Cancel" />
                                ...
                                <div id="container" class="tab-pane fade" style="height: 400px; width: 796px">
    ...
    <cc1:TabContainer Visible="false"  CssClass="MyTabStyle" ID="TabContainer1" ActiveTabIndex="0" runat="server" Width="100%"
