 <%@ Page Title="Display" Language="C#" MasterPageFile="~/AdminModule_New.master" AutoEventWireup="true"
    CodeFile="DisplaySM.aspx.cs" Inherits="DisplaySM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     ...
     <a href="SMHome.aspx" title="Back to SM Dashboard">
            ...
            <td align="center" valign="middle">
                <table style="width: 600px; height: 50px;" border="0" cellpadding="1" cellspacing="10">
                    ...
                    <tr>
                        ...
                        <td align="center" height="200">
                            <asp:ImageButton ID="BtnFIDisplay" runat="server" Height="100%" Width="400px"
                    ...
                    <%--    </td>
                        ...
                        <td align="center" height="200">
                            <asp:ImageButton ID="BtnWashDisplay" runat="server" Height="100%" Width="400px"
